...
class HasMeterReadingType(Enum):
    Coal = 'Coal'
...
class Meter(BaseModel):
    ...
    hasMeterReading: Optional[float] = Field(
        None,
        description='A relationship between a metering function and the measurement of the reading',
    )
    hasMeterReadingType: Optional[HasMeterReadingType] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='It must be equal to `Meter`')
